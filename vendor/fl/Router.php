...
class Router
{
    ...
    private static function removeQueryString($url):int
    {
        if ($url) {
    ...
    //LandLang
    private static function getLandLang():int
    {
        $res = 1;
    ...
    //Land
    private static function setLand($land):int
    {
    ...
    //Lang
    private static function setLanguage($lang):int
    {
    ...
    private static function validateLanguage($lang):int
    {
        return 1;
    }

    //Prefix
    private static function getPrefixLandLang($ll):int
    {
